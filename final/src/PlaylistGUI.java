...
public class PlaylistGUI extends JFrame {
    ...
    JTextArea playlistArea;
    JTextField songField, indexField;
    JLabel nowPlaying;
...
JButton btnBack = new JButton("Back to Contacts");
        ...
        bottomPanel.add(btnBack);  // <-- new button

        bottomPanel.add(nowPlaying);


        btnBack.addActionListener(e -> {
    new contact();   // open contact GUI
