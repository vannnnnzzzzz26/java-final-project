...
public class CircularTable extends JFrame {
    ...
    public CircularTable() {
        ...
        addBetweenBtn.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(this, panel, "Insert Between", JOptionPane.OK_CANCEL_OPTION);
            if (result == JOptionPane.OK_OPTION) {
                boolean success = seating.insertBetween(firstField.getText().trim(), secondField.getText().trim(), newNameField.getText().trim());
                if (!success) JOptionPane.showMessageDialog(this, "Pair not found!");
                displayArea.setText(seating.traverseClockwise());
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(CircularTable::new);
    }
}
